<template>
    <div class="profile-activity-content-container">
       <div class="profile-content-type-posts" v-if="activityType === 'posts'">
       ...
       <div class="profile-content-type-bookmarks" v-show="activityType === 'bookmarks'">
...
export default {
    data(){
        return{
            ...
            userId:this.$store.state.auth.loged_in_user_obj.id
    ...
    computed:{ // getCollection
       current_user_viewd_posts(){
        ...
        const check = find_user != null &&  find_user.postsViewed != null?  find_user.postsViewed : null  // postsViewed
        console.log('why man?',find_user,'//',check)
         return check
       },
    ...
    async created(){
        // const call_resourses = async(type = 'posts')=>{
        ...
        //        console.log('hey',posts_loaded)
        //        return posts_viewed
        // }
        
          
        //   if(this.activityType === 'posts'){ // working one but only for posts
        ...
        //         return
        //   }// working one but only for posts

    ///use this 
          // const posts_loaded =
            await this.$store.dispatch('posts/getInitialPostsByIds',{userId:this.userId,for_type:this.activityType})//await
            ...
            //     return
            //    }
            //    if(activityType === 'bookmarks'){
            //         const user_bookmarks_viewed = this.$store.state.auth.loged_in_user_obj.bookmarksViewed || []
            //         return 
            //    }
    ...
    ///
        ...
        //     await custom_call_resourses('posts')//
        //    }
